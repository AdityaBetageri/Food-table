    ...
    <div className="legal-page-wrapper">
      <div className="legal-page-container">
        ...
        <div className="legal-content">
          <p>■ Cookies Policy How TableTap uses cookies and tracking technologies Platform: TableTap — Smart QR Restaurant Ordering System Contact: legal@tabletap.in Applies To: All users of TableTap — Hotel Owners, Staff, and Customers Related Documents: See also: Privacy Policy, Terms &amp; Conditions This policy explains what cookies we use, why we use them, and how you can control them. Essential cookies cannot be disabled as they are required for the Service to function. Effective: 27 April 2025</p>

          <h3> What Are Cookies?</h3>
          <p>Cookies are small text files placed on your device when you visit a website or web application. They are widely used to make websites work, provide personalised experiences, and give operators usage information. TableTap also uses localStorage and sessionStorage — browser-based storage technologies that function similarly. This policy covers all such technologies.</p>
          <h3> How TableTap Uses Cookies</h3>
          ...
          <p>On your first visit to the TableTap customer menu page, a consent banner lets you choose: Accept All, Essential Only, or Customise. Essential cookies are always active.</p>
          ...
          <p>Some browsers send a DNT signal. There is currently no universal standard for responding to DNT. TableTap does not currently respond to DNT signals — use the controls in Section 3.7 to manage tracking.</p>
          ...
          <hr></hr>
          <p style={{ textAlign: 'center', marginTop: '16px', color: '#718096', marginBottom: '40px', fontSize: '0.95rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '20px' }}>©2026 TableTap. All rights reserved. Last updated: April 30, 2026</p>
        </div>
      </div>
    </div>
  );
