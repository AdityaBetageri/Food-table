    ...
    <div className="legal-page-wrapper">
      <div className="legal-page-container">
        ...
        <div className="legal-content">
          ...
          <p> No Registration Required: Customers are not required to create an account  Session Data: Table number (from QR URL), cart items, orders placed — linked to a temporary session ID  Device Data: Browser type, OS, device type, screen resolution  Feedback: Star rating and optional comment after an order  Payment Reference: Transaction ID only (if online payment is used). Card/UPI details never stored by TryScan  Contact Info (optional): Phone number, only if voluntarily provided for WhatsApp bill or reservation</p>
          ...
          <p> Right to Access: Request a copy of personal data we hold about you  Right to Correction: Request correction of inaccurate or incomplete data  Right to Erasure: Request deletion, subject to legal retention requirements  Right to Grievance Redressal: Lodge a complaint with our Grievance Officer at grievance@tryscan.in — response within 30 days  Right to Withdraw Consent: Withdraw consent for optional processing at any time  Right to Data Portability: Request your account data in JSON or CSV format To exercise any right, email legal@tryscan.in with your account email and request description. We respond within 30 days.</p>
          <h3> Children's Privacy</h3>
          <p>TryScan does not knowingly collect personal data from children under 18. Our platform is intended for adults. If we discover minor's data has been collected, we will delete it promptly. Contact legal@tryscan.in if you have concerns.</p>
          ...
          <p>We may update this Privacy Policy periodically. Material changes will be communicated via email to hotel owners and in-dashboard notices. The effective date at the top indicates the last revision. Privacy concerns? Data requests: legal@tryscan.in | Grievances: grievance@tryscan.in |</p>
          <hr></hr>
          <p style={{ textAlign: 'center', color: '#718096', marginTop: '16px', marginBottom: '40px', fontSize: '0.95rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '20px' }}>©2026 TryScan. All rights reserved. Last updated: April 30, 2026</p>
        </div>
      </div>
    </div>
  );
